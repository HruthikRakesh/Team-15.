...
Paste your own secret API key from Google AI Studio in place of "YOUR_API_KEY".
5. Start the App
python app.py
...
![vedio](https://github.com/HruthikRakesh/Team-15./blob/main/2026-01-22%20at%208.54.28%20PM.mp4)
